export const fr = {
  ...
  NewGroup: {
    ...
    categories: {
      ...
      ART_AND_CULTURE: "Art et culture",
      TRAVEL: "Voyages",
      ...
      PETS_AND_ANIMALS: "Animaux domestiques",
      REAL_ESTATE: "Immobilier",
      AUTOMOTIVE: "Automobile",
      DIY_AND_CRAFTS: "DIY et artisanat",
      BOOKS_AND_LITERATURE: "Livres et littérature",
      PARENTING_AND_FAMILY: "Parentalité et famille",
      POLITICS_AND_SOCIETY: "Politique et société",
      RELIGION_AND_SPIRITUALITY: "Religion et spiritualité",
      CAREER_AND_NETWORKING: "Carrière et réseautage",
      FILM_AND_TV: "Cinéma et TV",
      FITNESS_AND_BODYBUILDING: "Fitness et musculation",
      OTHER: "Autre",
    },
    limit: {
