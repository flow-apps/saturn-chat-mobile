export const es = {
  ...
  NewGroup: {
    ...
    categories: {
      ...
      TRAVEL: "Viajes",
      FOOD_AND_DRINK: "Comida y bebidas",
      GAMING: "Videojuegos",
      MUSIC: "Música",
      SCIENCE: "Ciencia",
      ...
      DIY_AND_CRAFTS: "Hazlo tú mismo y manualidades",
      BOOKS_AND_LITERATURE: "Libros y literatura",
      PARENTING_AND_FAMILY: "Crianza y familia",
      POLITICS_AND_SOCIETY: "Política y sociedad",
      RELIGION_AND_SPIRITUALITY: "Religión y espiritualidad",
      CAREER_AND_NETWORKING: "Carrera y networking",
      FILM_AND_TV: "Cine y TV",
      FITNESS_AND_BODYBUILDING: "Fitness y culturismo",
      OTHER: "Otro",
    },
    limit: {
  ...
  Settings: {
    ...
    account: {
      ...
      security: {
        ...
        unavailable_title: "Autenticación local no disponible",
        unavailable_content:
          "Registra una biometría o contraseña del dispositivo para activar esta opción.",
        unlock_prompt: "Desbloquea Saturn Chat",
        unlock_message: "Autentícate para abrir Saturn Chat",
  ...
  GroupConfig: {
    ...
    alerts: {
      error: {
        title: "Error",
        content: "No se pudieron cargar las configuraciones del grupo.",
      },
      delete_group: {
