export const pt = {
  ...
  NewGroup: {
    ...
    categories: {
      ...
      TRAVEL: "Viagens",
      FOOD_AND_DRINK: "Comida e bebidas",
      GAMING: "Jogos",
      MUSIC: "Música",
      SCIENCE: "Ciência",
      ...
      PETS_AND_ANIMALS: "Animais de estimação",
      REAL_ESTATE: "Imóveis",
      AUTOMOTIVE: "Automotivo",
      DIY_AND_CRAFTS: "Faça você mesmo e artesanato",
      BOOKS_AND_LITERATURE: "Livros e literatura",
      PARENTING_AND_FAMILY: "Criação de filhos e família",
      POLITICS_AND_SOCIETY: "Política e sociedade",
      RELIGION_AND_SPIRITUALITY: "Religião e espiritualidade",
      CAREER_AND_NETWORKING: "Carreira e networking",
      FILM_AND_TV: "Filmes e TV",
      FITNESS_AND_BODYBUILDING: "Fitness e musculação",
      OTHER: "Outro",
    },
    limit: {
  ...
  Settings: {
    ...
    account: {
      ...
      security: {
        ...
        unavailable_title: "Autenticação local indisponível",
        unavailable_content:
          "Cadastre uma biometria ou senha no dispositivo para ativar esta opção.",
        unlock_prompt: "Desbloqueie o Saturn Chat",
        unlock_message: "Autentique-se para abrir o Saturn Chat",
  ...
  GroupConfig: {
    ...
    alerts: {
      error: {
        title: "Erro",
        content: "Não foi possível carregar as configurações do grupo.",
      },
      delete_group: {
